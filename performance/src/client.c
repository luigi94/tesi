...
void recv_data(const int socket_fd, unsigned char** const restrict data_buf, const unsigned long* const restrict data_size){
...
int main(int argc, char *argv[]) {
	...
	if(type == 0){
		...
		write_binary(partial_updates_buf, UPDATES_LEN, "par_upd");
