...
seabrew-abe-keygen -o blue_vehicle_priv_key pub_key master_key CAR_MODEL_23 ECU_MODEL_2247 ECU_MODEL_2256 ECU_MODEL_2268
seabrew-abe-keygen -o green_vehicle_priv_key pub_key master_key CAR_MODEL_21 ECU_MODEL_2246 ECU_MODEL_2248
...
cp -f blue_vehicle_priv_key.d Server_4
cp -f green_vehicle_priv_key.d Server_4
cp -f vim-runtime_2%3a8.1.2269-1ubuntu5_all.deb Server_4
...
sshpass -p 'root' ssh root@192.168.1.200 "rm -rf /root/Documents/tesi/performance/"
sshpass -p 'root' ssh root@192.168.1.200 "mkdir /root/Documents/tesi/performance/"
sshpass -p 'root' ssh root@192.168.1.200 "mkdir /root/Documents/tesi/performance/src"
...
rm -f blue_vehicle_priv_key.d
rm -f green_vehicle_priv_key.d
rm -f master_key
rm -f pub_key
rm -f srvprvkey.pem
rm -f srvpubkey.pem
