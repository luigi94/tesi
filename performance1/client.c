...
#if SECURITY == 128
#define PUBLIC_KEY_NAME_PREFIX "./../3072_bits_keys/srvpubkey%u.pem"
#elif SECURITY == 192
#define PUBLIC_KEY_NAME_PREFIX "./../7680_bits_keys/srvpubkey%u.pem"
#elif SECURITY == 256
#define PUBLIC_KEY_NAME_PREFIX "./../15360_bits_keys/srvpubkey%u.pem"
#endif
